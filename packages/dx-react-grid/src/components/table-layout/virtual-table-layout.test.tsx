...
import { Sizer } from '@synconset/dx-react-core';
import {
  getCollapsedGrids,
  TABLE_FLEX_TYPE,
  emptyViewport,
...
jest.mock('@synconset/dx-react-core', () => {
  const { Component } = jest.requireActual('react');
  return {
    ...jest.requireActual('@synconset/dx-react-core'),
  ...
  it('should not render width for a flex column', () => {
    ...
    getCollapsedGrids
      .mockImplementationOnce((args) => {
        const result = jest.requireActual('@synconset/dx-grid-core').getCollapsedGrids(args);
    ...
    it('should specify correct row height at startup', () => {
      ...
      getCollapsedGrids
        .mockImplementationOnce((args) => {
          ...
          return jest.requireActual('@synconset/dx-grid-core').getCollapsedGrids(args);
        });
